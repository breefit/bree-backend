...
import { getProducts, getProduct, getHomeProducts, getRecommendations } from '../controllers/productController.js';
import { getMyOrders, getOrder, getOrderTracking, validateCart, createOrder as createOrderCheckout, updatePaymentStatus } from '../controllers/orderController.js';
import { createOrder, verifyPayment, handleWebhook, getPaymentStatus } from '../controllers/paymentController.js';
import { getProfile, updateProfile, changePassword } from '../controllers/profileController.js';
import { getAddresses, addAddress, updateAddress, deleteAddress, setDefault } from '../controllers/addressController.js';
...
// Tracking endpoint must come before generic /:id route to avoid route conflicts
...
orderRouter.post('/validate-cart',    auth, validateCart);
